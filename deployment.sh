...
docker build -t my-model:0.3 .
docker tag my-model:0.3 jsilverstein/my-model:0.3
docker push jsilverstein/my-model:0.3
docker run -d --rm --name my-model -p 9000:9000 my-model:0.3
